...
import type { Feature, User, SubFeature } from '@/app/types';
...
const FeatureList = ({ projectId, onFeatureUpdated }: FeatureListProps) => {
  ...
  const [showSubFeaturesModal, setShowSubFeaturesModal] = useState(false);
  const [loadingSubFeatures, setLoadingSubFeatures] = useState(false);
  const [showSubFeatureForm, setShowSubFeatureForm] = useState(false);
